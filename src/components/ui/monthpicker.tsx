				...
				<div className="space-x-1 flex items-center">
					<button
						...
						className={cn(
							...
							'inline-flex items-center justify-center h-7 w-7 p-0 absolute left-1 cursor-pointer'
						)}
					>
					...
					<button
						...
						className={cn(
							...
							'inline-flex items-center justify-center h-7 w-7 p-0 absolute right-1 cursor-pointer'
						)}
					>
										...
										>
											<button
												...
												className={cn(
													...
													'h-full w-full p-0 cursor-pointer font-normal aria-selected:opacity-100'
												)}
											>
